...
func main() {
	...
	result, err := page.BackfillInteractiveResponses(context.Background(), database.DB, *afterID, *limit)
	if err != nil {
		fmt.Fprintln(os.Stderr, "backfill page interactive responses:", err)
		os.Exit(1)
	}
