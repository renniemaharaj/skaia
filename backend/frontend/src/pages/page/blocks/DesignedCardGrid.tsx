 ...
 * Compatible with PageItem[] generated by mapRowsToItems().
 */
import type { PageItem, CardTemplate, CardZone } from "../types";
...
function renderZone(zone: CardZone, item: PageItem) {
