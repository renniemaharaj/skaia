...
export default function JsonViewer({ flowState }: { flowState: FlowState }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "0.75rem", borderBottom: "1px solid var(--border-color)", background: "var(--bg-color)" }}>
      ...
      <div style={{ flex: 1, padding: "0.75rem", overflow: "hidden", background: "var(--bg-color)" }}>
        <pre style={{
          margin: 0,
          padding: "1rem",
