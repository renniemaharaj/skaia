...
// Rounded Square Node
export const RoundedSquareNode = memo(({ data }: NodeProps & CustomNodeProps) => (
  <Node
    handles={handles}
    layout="horizontal"
    icon={
    ...
    icon={
      <div
        style={{
          ...
          flexShrink: 0,
          clipPath:
            "polygon(33.33% 0%, 66.66% 0%, 66.66% 33.33%, 100% 33.33%, 100% 66.66%, 66.66% 66.66%, 66.66% 100%, 33.33% 100%, 33.33% 66.66%, 0% 66.66%, 0% 33.33%, 33.33% 33.33%)",
        }}
      />
    }
...
// Parallelogram Node
export const ParallelogramNode = memo(({ data }: NodeProps & CustomNodeProps) => (
  <Node
    handles={handles}
    layout="horizontal"
    icon={
