...
export const CenterAnchoredSystem: React.FC<CenterAnchoredSystemProps> = ({ particleCount = 250 }) => {
...
export const TextGravityRenderer: React.FC<TextGravityRendererProps> = ({ text, particleCount = 400 }) => {
  const [attractors, setAttractors] = useState<AttractorParticle[]>([]);
