  ...
  return (
    <ManagedForm<ProductValues>
      ...
      validate={values => ({
        ...
        ...(Number.isNaN(Number.parseFloat(values.price)) ? { price: "Enter a valid price" } : {}),
      })}
      onSubmit={async (values, helpers) => {
        ...
        try {
          ...
          helpers.setStatus(error instanceof Error ? error.message : "Failed to update product");
        }
      }}
    >
      {formik => (
                ...
                <Button
                  ...
                  onClick={() =>
                    void formik.setFieldValue(
                      "special_actions",
                      formik.values.special_actions.filter((_, itemIndex) => itemIndex !== index)
                    )
                  }
                >
                  <X size={18} />
