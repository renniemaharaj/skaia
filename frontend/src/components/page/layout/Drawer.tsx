...
export function Drawer({
  ...
  const availableTools: DrawerAppOption[] = [
    ...
    { id: "layout", label: layoutMode === "application" ? "Web mode" : "App mode" },
  ...
  const allApps: DrawerAppOption[] = [
    ...navigationItems.map(item => ({ id: navigationAppId(item), label: item.label })),
    ...availableTools,
  ];
  ...
  return (
    ...
    >
      ...
      >
        <Grid3X3 size={19} />
        <span className="utility-launcher__trigger-label">Launcher</span>
          ...
          <div className="drawer-customizer">
            <div className="drawer-customizer__fields">
              ...
              <Select
                ...
                onChange={event =>
                  onSaveBranding({ drawer_show_labels: event.target.value === "show" })
                }
              />
            </div>
