  ...
  return (
    <div className="column-mapper column-mapper--component-bind">
      <div className="column-mapper-header">
        <span className="column-mapper-title">Bind Data to {component.label}</span>
            ...
            >
              <div className="column-mapper-slot-meta">
                <span className="column-mapper-slot-label">
                  {bp.label} {bp.required && <span className="column-mapper-required">*</span>}
                </span>
                <span className="column-mapper-slot-kind">{bp.kind}</span>
              </div>
