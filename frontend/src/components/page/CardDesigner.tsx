...
export const CardDesigner = ({ template, onChange, mode = "card" }: CardDesignerProps) => {
  ...
  const updateZone = useCallback(
    (index: number, updates: Partial<CardZone>) => {
      const zones = template.zones.map((z, i) => (i === index ? { ...z, ...updates } : z));
  ...
  return (
    <div className="card-designer">
      <div className="card-designer__header">
        ...
        <Button unstyled type="button" className="card-designer__reset" onClick={resetToDefault}>
          Reset
        </Button>
      </div>
        ...
        <div className="card-designer__section">
          ...
          >
            <div>
              ...
              <span className="card-designer__group-note">Size, behavior, and surface style</span>
            </div>
            <ChevronDown size={16} />
          </Button>
              ...
              <div className="cd-ctrl-row">
                <span className="cd-ctrl">
                  ...
                  <Select
                    ...
                    onChange={e => updateTemplate({ cardWidth: e.target.value as CardWidth })}
                    size="sm"
                    variant="minimal"
                  >
                ...
                <span className="cd-ctrl">
                  ...
                  <Select
                    ...
                    onChange={e =>
                      updateTemplate({
                        aspectRatio: e.target.value === "auto" ? undefined : e.target.value,
                      })
                    }
                    size="sm"
                    variant="minimal"
              ...
              <div className="cd-ctrl-row">
                ...
                <div className="cd-range-row cd-range-row--grow">
                  <input
                    ...
                    onChange={e => updateTemplate({ borderRadius: Number(e.target.value) })}
                  />
                  <span className="cd-range-value">{template.borderRadius ?? 16}px</span>
                </div>
              </div>
        ...
        <div className="card-designer__section">
          ...
          >
            <div>
              ...
              <span className="card-designer__group-note">Grid + padding controls</span>
            </div>
            <ChevronDown size={16} />
          </Button>
              ...
              <div className="cd-ctrl-row">
                <span className="cd-ctrl">
                  ...
                  <input
                    ...
                    onChange={e => updateTemplate({ gridGap: Number(e.target.value) })}
                  />
                </span>
                <span className="cd-ctrl">
                  <label>Zone</label>
              ...
              <div className="card-designer__section-body">
                <div className="cd-ctrl-row">
                  <Button
                    ...
                    onClick={() => updateTemplate({ tableStriped: !template.tableStriped })}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => updateTemplate({ tableHover: !template.tableHover })}
                  >
                    <span className="cd-toggle__dot" />
                    Hover
                  </Button>
                  <Button
                    ...
                    onClick={() => updateTemplate({ tableBordered: !template.tableBordered })}
                  >
                    <span className="cd-toggle__dot" />
                    Bordered
                  </Button>
                  <Button
                    ...
                    onClick={() => updateTemplate({ tableCompact: !template.tableCompact })}
                  >
                    <span className="cd-toggle__dot" />
                    Compact
                  </Button>
            ...
            <div className="card-designer__section-body">
              <div className="card-designer__field card-designer__field--wide">
                ...
                <div className="card-designer__css-editor-wrapper">
                  <Suspense
                    fallback={
                      <div className="card-designer__css-editor-fallback">Loading editor…</div>
                    }
                  >
                    <MonacoEditor
                      height={260}
                ...
                <span className="card-designer__field-note">
                  Use <code>.dcard--custom-css</code> to scope custom rules to the rendered card or
                  table.
                </span>
              </div>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="card-designer__zone-size">
                        {ZONE_SIZE_OPTIONS.map(opt => (
                          <Button
                            ...
                            onClick={() => updateZone(originalIndex, { size: opt.value })}
                          >
                            {opt.label}
                          </Button>
                        ))}
                      ...
                      <Button
                        ...
                        onClick={() => {
                          const prevOriginal = bodyZoneIndices[visualIndex - 1]?.originalIndex;
                          if (prevOriginal !== undefined) moveZone(originalIndex, prevOriginal);
                        }}
                        title="Move up"
                      >
                        <ChevronUp size={12} />
                      ...
                      <Button
                        ...
                        onClick={() => {
                          const nextOriginal = bodyZoneIndices[visualIndex + 1]?.originalIndex;
                          if (nextOriginal !== undefined) moveZone(originalIndex, nextOriginal);
                        }}
                        title="Move down"
                      >
                        <ChevronDown size={12} />
                      ...
                      <Button
                        ...
                        onClick={() => updateZone(originalIndex, { visible: !zone.visible })}
