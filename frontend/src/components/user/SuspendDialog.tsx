    ...
    <div className="up-dialog-overlay" onClick={onClose}>
      <div className="up-dialog" onClick={e => e.stopPropagation()}>
        ...
        <div className="up-dialog-footer">
          <button className="up-btn up-btn-secondary" onClick={onClose} disabled={suspendLoading}>
            Cancel
          </button>
          <button className="up-btn up-btn-danger" onClick={onConfirm} disabled={suspendLoading}>
            {suspendLoading ? <span className="up-spinner" /> : <Shield size={14} />}
            Confirm Suspend
          </button>
        </div>
      </div>
